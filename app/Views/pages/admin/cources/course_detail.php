...
<div class="container <?= ($course_id === '2') ? '' : 'd-none' ?>" id="2">
    <!-- Course Banner -->
    <section class="bg-dark text-white text-center py-5" style="background-image: url('https://example.com/path-to-your-banner-image.jpg'); background-size: cover; background-position: center;">
        <div class="container">
            <h1 class="display-4 fw-bold">Quran Majjedd</h1>
            <p class="lead">Explore the Islamic system of society, rights of Allah, and human relations.</p>
        </div>
    </section>
</div>
<!-- </section> -->
