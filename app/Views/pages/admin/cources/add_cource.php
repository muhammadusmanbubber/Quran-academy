...
<div class="container">
    ...
    <div class="row">
        <div class="d-flex justify-content-between align-items-center">
            <h2 class="text-primary fw-bold mb-4">Add Course</h2>
        </div>
        <!-----Add Course Form ----->
        <form method="post" enctype="multipart/form-data" action="<?= base_url('admin/cources/save-cource') ?>">
            ...
            <div class="row" scroll-target="basic_info">
                <div class="col-md-6 mb-2">
                    ...
                    <input type="text" class="form-control passenger_form_input" placeholder="Maximum Course Duration" name="course_duration" value="<?= old('course_duration') ?>">
                    <!-- Validation Error -->
            ...
            <div class="col-md-12 mb-4 mt-3">
                <label class="form-label passenger_form_label color_primary mb-2">
                    Course Cover Image <span class="required_show">*</span>
                </label>
                ...
                <input type="hidden" id="profile-image" name="cover_image">
